...
DISTANCE_SENSOR_POLL_PERIOD = 0.2
DISTANCE_SENSOR_SRV_FREQUENCY = 100
DISTANCE_SENSOR_SRV_TIMEOUT = 1
DISTANCE_SENSOR_SRV_AVERAGE_SIZE = 16 
...
IMU_ACCELEROMETER_CALIBRATION_PERIOD = 5

OPTICAL_CALIBRATION = 1
OPTICAL_MOVE_TIME = 0.6
OPTICAL_CALIBRATION_LOOP_RATE = 100
ENCODER_OFFSET_X_AXIS = 49

GPS_DEV_PORT = "/dev/ttyAMA0"
